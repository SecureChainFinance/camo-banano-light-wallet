...
const AutoRecieveButton = () => {
  if (app.getUseAutoRecieve()) {
    return <DisableableButton name="disableAutoRecieve" onClick={(e) => app.setAutoRecieve(false)} />;
  } else {
    return <DisableableButton name="enableAutoRecieve" onClick={(e) => app.setAutoRecieve(true)} />;
  }
};
  ...
  return (
    <table className="yellow_on_brown h20px darkgray_border bordered">
      <tbody>
        <tr>
          <td>
            <Localization name="balance" />
          </td>
          <td>{totals.balance}</td>
        </tr>
        <tr>
          <td>
            <Localization name="pendingBalance" />
          </td>
          <td>{totals.pendingBalance}</td>
        </tr>
        <tr>
          <td>
            <Localization name="camoBalance" />
          </td>
          <td>{totals.camoBalance}</td>
        </tr>
        <tr>
          <td>
            <Localization name="camoPendingBalance" />
          </td>
...
const LocalizationInput = (props) => {
  ...
  return <input style={props.style} type={props.type} size={props.size} id={props.id} placeholder={localizedPlaceholder}></input>;
};
...
const UseLedgerButton = () => {
  if (app.getLedgerDeviceInfo() ? app.getLedgerDeviceInfo().supported : false) {
    return (
      <div className="yellow_on_black bordered display_inline_block float_right fake_button rounded padding_5px" onClick={(e) => app.useLedger()}>
        Use Ledger
      </div>
    );
  } else {
...
const SendFromSeedIxField = () => {
  ...
  if (accountBook[0]) {
    ...
    return (
      <select id="sendFromSeedIx" onChange={(e) => app.updateCamoSharedAccount()} disabled={app.isUpdateInProgress()}>
        {validAccountBook.map((item, index) => {
          if (app.getUseCamo()) {
            return (
              <option key={index} value={item.seedIx}>
                [{item.seedIx}]{item.camoAccount} ({item.balance} BAN)
              </option>
            );
          } else {
            return (
              <option key={index} value={item.seedIx}>
                [{item.seedIx}]{item.account} ({item.balance} BAN)
              </option>
            );
          }
        })}
...
const SendToAccountField = () => {
  if (app.getUseCamo()) {
    ...
    if (accountBook[0]) {
      return (
        <select id="sendToAccount" onChange={(e) => app.updateCamoSharedAccount()} disabled={app.isUpdateInProgress()}>
          {accountBook.map((item, index) => {
            ...
            if (skip) {
              ...
              return (
                <option key={index} value={item.camoAccount}>
                  {item.camoAccount}
                </option>
              );
            }
...
const DisableableButton = (props) => {
  ...
  if (app.isUpdateInProgress()) {
    return <div className="black_on_gray bordered display_inline_block float_right fake_button rounded padding_5px">{localizedName}</div>;
  } else {
    return (
      <div
...
const DeleteAccountFromBookButton = (props) => {
  ...
  if (item.readOnly) {
    ...
    return (
      <div
        className="yellow_on_black gray_border bordered display_inline_block float_right fake_button rounded padding_5px"
        onClick={(e) => app.deleteAccountFromBook(item.bookAccountIx)}
      >
        X
      </div>
    );
...
const UseCamoButton = () => {
  if (app.getUseCamo()) {
    return (
      <div className="h310px overflow_auto">
        <div className="gray_on_yellow">
          <Localization name="usingCamoToSendTransaction" />
        </div>
        <div className="black_on_gray gray_border bordered display_inline_block float_right fake_button_disabled rounded padding_5px">
          <Localization name="enableCamo" />
        </div>
        <DisableableButton name="disableCamo" onClick={(e) => app.setUseCamo(false)} />
        <div className="gray_on_yellow">
          <Localization name="firstAccountWithNoTransactions" />
        </div>
    ...
    return (
      <div>
        <div className="gray_on_yellow">
          <Localization name="sendingRegularTransaction" />
        </div>
        <DisableableButton name="enableCamo" onClick={(e) => app.setUseCamo(true)} />
        <div className="black_on_gray gray_border bordered display_inline_block float_right fake_button_disabled rounded padding_5px">
          <Localization name="disableCamo" />
        </div>
      </div>
    );
  }
        ...
        <table className="w800h600px no_padding no_border">
          <tbody>
            <tr className="no_padding">
              <td
                className="valign_top yellow_on_brown no_border"
                style={{
                  width: '150px',
                }}
              >
                  ...
                  <tbody>
                    <tr>
                      <td className="h20px no_border user_select_none">
                        <select value={app.getLanguage()} name="network" onChange={(e) => app.changeLanguage(e)} disabled={app.isUpdateInProgress()}>
                    ...
                    <tr>
                      <td>
                        ...
                        <select value={app.getCurrentNetworkIx()} name="network" onChange={(e) => app.changeNetwork(e)} disabled={app.isUpdateInProgress()}>
                    ...
                    <tr>
                      <td id="send" className="yellow_on_brown_with_hover h20px fake_button" onClick={(e) => app.showSend()}>
                        ...
                        <Localization name="send" />
                      </td>
                    </tr>
                    <tr>
                      <td id="sendToList" className="yellow_on_brown_with_hover h20px fake_button" onClick={(e) => app.showSendToList()}>
                        <img className="valign_middle svg" src="artwork/send.svg"></img>&nbsp;
                        <Localization name="sendToList" />
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td id="transactions" className="yellow_on_brown_with_hover h20px fake_button" onClick={(e) => app.showTransactions()}>
                        ...
                        <Localization name="transactions" />
                      </td>
                    </tr>
                    <tr>
                      <td id="representatives" className="yellow_on_brown_with_hover h20px fake_button" onClick={(e) => app.showRepresentatives()}>
                        ...
                        <Localization name="representative" />
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td className="yellow_on_brown_with_hover h20px fake_button" onClick={(e) => app.requestAllBlockchainDataAndRenderApp()}>
                        <Localization name="refresh" />
                      </td>
                    </tr>
                    <tr>
                      <td className="yellow_on_brown_with_hover h20px fake_button" onClick={(e) => app.showLogin()}>
                        <Localization name="logout" />
                      </td>
                    </tr>
                    <tr>
                      <td className="yellow_on_brown_with_hover h20px fake_button" onClick={(e) => openDevTools()}>
                        <Localization name="showDevTools" />
                      </td>
                    </tr>
                  </tbody>
                </table>
                  ...
                  <tbody>
                    ...
                    <tr id="seed-login">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <div className="gray_on_yellow">
                          <Localization name="seed" />
                        </div>
                        <p>
                          <Localization name="enterSeedManually" />
                        </p>
                        <div className="yellow_on_black bordered display_inline_block float_right fake_button rounded padding_5px" onClick={(e) => app.showSeedEntry()}>
                          <Localization name="enterSeed" />
                        </div>
                      </td>
                    </tr>
                    <tr id="seed-reuse">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <div className="gray_on_yellow">
                          <Localization name="reuseStoredSeed" />
                        </div>
                        <p>
                          <Localization name="reuseSeedMessage" />
                        </p>
                    ...
                    <tr id="seed-reuse-entry">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        ...
                        <div className="gray_on_yellow">
                          <Localization name="seedStoragePasswordOptional" />
                        </div>
                        <br />
                        <LocalizationInput
                    ...
                    <tr id="seed-entry">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        ...
                        <hr />
                        <div className="gray_on_yellow">
                          <Localization name="storeSeed" />
                        </div>
                        <br />
                        <input type="checkbox" id="storeSeed"></input>
                        <Localization name="storeSeedLocallyForReuse" />
                        <br />
                        <div className="gray_on_yellow">
                          <Localization name="seedStoragePasswordOptional" />
                        </div>
                        ...
                        <LocalizationInput
                          ...
                          size="66"
                          maxLength="64"
                          id="storeSeedPassword"
                          placeholder="storagePasswordOptional"
                        />
                        <br />
                        <div
                          className="yellow_on_black bordered display_inline_block float_right fake_button rounded padding_5px"
                          onClick={(e) => app.getAccountDataFromSeed()}
                        >
                          <Localization name="useSeed" />
                        </div>
                      </td>
                    </tr>
                    <tr id="private-key-generate">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <div className="gray_on_yellow">
                          <Localization name="generateNewSeed" />
                        </div>
                        <p>
                          <Localization name="generateNewSeedMessage" />
                        </p>
                        <div
                          className="yellow_on_black bordered display_inline_block float_right fake_button rounded padding_5px"
                          onClick={(e) => app.showGenerateNewSeed()}
                        >
                          <Localization name="generateSeed" />
                        </div>
                      </td>
                    </tr>
                    <tr id="private-key-generator">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <div className="gray_on_yellow">
                          <Localization name="newSeed" />
                        </div>
                        {app.getGeneratedSeedHex()}
                        <br />
                        <div className="yellow_on_black bordered display_inline_block float_left fake_button rounded padding_5px" onClick={(e) => app.copyToClipboard()}>
                          <Localization name="copy" />
                        </div>
                        <br />
                        <div className="yellow_on_black bordered display_inline_block float_right fake_button rounded padding_5px" onClick={(e) => app.showLogin()}>
                          <Localization name="done" />
                        </div>
                      </td>
                    </tr>
                    <tr id="ledger-login">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <div className="gray_on_yellow">
                          <Localization name="ledgerStatus" />
                        </div>
                        <p>
                          <LedgerMessage />
                        </p>
                    ...
                    <tr id="your-account">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <div className="gray_on_yellow">
                          <Localization name="yourPrimaryAccount" />
                        </div>
                        <br />
                        {app.getAccountZero()}
                        <div className="gray_on_yellow">
                          <Localization name="yourCamoAccount" />
                        </div>
                        <br />
                        {app.getCamoAccount()}
                      </td>
                    ...
                    <tr id="your-representative">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <div className="gray_on_yellow">
                          <Localization name="yourCurrentRepresentative" />
                        </div>
                        <br />
                        {app.getAccountRepresentative()}
                        <hr />
                        <div className="gray_on_yellow">
                          <Localization name="yourCamoRepresentative" />
                        </div>
                        <br />
                        {app.getCamoRepresentative()}
                      </td>
                    </tr>
                    <tr id="update-representative">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <div className="gray_on_yellow">
                          <Localization name="newRepresentative" /> (ban_ or camo_)
                        </div>
                        <br />
                        <LocalizationInput className="monospace no_pad" type="text" size="67" maxLength="65" id="newRepresentative" placeholder="representative" />
                        <hr />
                        <div
                          className="yellow_on_black bordered display_inline_block float_right fake_button rounded padding_5px"
                          onClick={(e) => app.updateRepresentative()}
                        >
                          <Localization name="updateRepresentative" />
                        </div>
                      </td>
                    </tr>
                    <tr id="pending">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <Localization name="autoRecieve" />
                        <br />
                        <Localization name="nextAutoRecieve" />
                        &nbsp;{app.getAutoRecieveCountdown()}
                        <br />
                          ...
                          {app.getPending().map((item, index) => {
                            if (item.firstHashForSourceAccount) {
                              return (
                                <tbody key={index}>
                                  <tr>
                                    <td className="no_border no_padding" colSpan="6">
                                      {item.sourceAccount}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td className="no_border no_padding">
                                      <a href={item.detailsUrl} onClick={(e) => onLinkClick(e)}>
                                        {item.hash}
                                      </a>
                                    </td>
                    ...
                    <tr id="transaction-list-small">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <div className="` display_inline_block">
                          <Localization name="previousTransactions" /> ({app.getTransactionHistoryByAccount().length + ' '}
                          <Localization name="total" />)
                        </div>
                        <div className="float_right display_inline_block">
                          {app.getBlockchainState().count + ' '}
                          ...
                          <tbody>
                            {app.getTransactionHistoryByAccount().map((item, index) => {
                              ...
                              if (item.account) {
                                return (
                                  <tr key={index}>
                                    <td colSpan="5" className="no_border no_padding">
                                      {item.account}
                                    </td>
                                  </tr>
                                );
                                ...
                                return (
                                  <tr key={index}>
                                    ...
                                    <td className="no_border no_padding">
                                      <a href={item.txDetailsUrl} onClick={(e) => onLinkClick(e)}>
                                        {item.txHash}
                                      </a>
                                    </td>
                            ...
                            <tbody>
                              {app.getTransactionHistoryByAccount().map((item, index) => {
                                if (item.account) {
                                  return (
                                    <tr key={index}>
                                      <td colSpan="5" className="darkgray_border no_padding">
                                        {item.account}
                                      </td>
                                    </tr>
                                  );
                    ...
                    <tr id="send-spacer-01">
                      <td className="yellow_on_brown h200px no_border">
                        <div className="gray_on_yellow">
                          <Localization name="balanceStatus" />
                        </div>
                        <br /> {app.getBalanceStatus()}
                        <br />
                        <div className="gray_on_yellow">
                          <Localization name="sendStatus" />
                        </div>
                        <br />
                        <table>
                          <tbody>
                    ...
                    <tr id="cancel-confirm-transaction">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <div className="gray_on_yellow">
                          <Localization name="confirm" />
                        </div>
                        <p></p>
                        <DisableableButton name="confirm" onClick={(e) => app.sendAmountToAccount()} />
                      </td>
                    </tr>
                    ...
                    <tr id="account-book">
                      <td className="yellow_on_brown h20px darkgray_border bordered">
                        <div className="h440px overflow_auto">
                          ...
                          <table className="w100pct no_border whitespace_nowrap">
                            <tbody>
                              <tr>
                                ...
                                <td className="no_border no_padding">
                                  <Localization name="camo" />
                                </td>
                                <td className="no_border no_padding">
                                  <Localization name="delete" />
                                </td>
                              </tr>
                          ...
                          <div
                            className="yellow_on_black gray_border bordered display_inline_block float_right fake_button rounded padding_5px"
                            onClick={(e) => app.addAccountToBook()}
                          >
                            <Localization name="addAccountToBook" />
                          </div>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr id="alert">
                      <td className="black_on_yellow h20px darkgray_border bordered">
                        <div className="display_inline_block">
                          <Localization name="alert" />:
                        </div>
                        <div className="display_inline_block">{app.getAlertMessage()}</div>
                        <DisableableButton name="ok" onClick={(e) => app.hideAlert()} />
                      </td>
                    </tr>
